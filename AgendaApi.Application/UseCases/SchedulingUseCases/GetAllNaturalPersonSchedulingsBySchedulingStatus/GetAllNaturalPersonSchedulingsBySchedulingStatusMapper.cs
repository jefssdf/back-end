...
{
    public sealed class GetAllNaturalPersonSchedulingsBySchedulingStatusMapper : Profile
    {
        public GetAllNaturalPersonSchedulingsBySchedulingStatusMapper()
        {
            CreateMap<Scheduling, GetAllNaturalPersonSchedulingsBySchedulingStatusResponse>()
